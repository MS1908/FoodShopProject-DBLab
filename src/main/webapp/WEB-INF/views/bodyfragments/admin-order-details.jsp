...
<script type="text/javascript" src="/resources/js/ajax/admin-order-details.js"></script>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="/admin">Admin Home</a></span> <span>Order</span></p>
    ...
    <div class="container">
        <div class="row justify-content-end">
            ...
            <div class="col-lg-3 mt-5 cart-wrap ftco-animate">
                <div id="admin-ord-stt-func" class="form-group"><a href="#" onclick="return changeStatus()" class="btn py-3 px-4 btn-warning">Change
                    Status</a></div>
                <div id="admin-ord-pay-func" class="form-group"><a href="#" onclick="return changePayment()" class="btn py-3 px-4 btn-warning">Change
                    Payment</a></div>
            </div>
